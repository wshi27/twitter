...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "GZyS7meGBg3mLmVGYfD5oY2sb", consumerSecret: "JUMMvhokplMf3HkHUEbSpndLr88WTEfRTBYLvzk4LBeMTZLgLp")
    var loginSuccess: (() -> ())?
    ...
    func login(url: String, success: @escaping () -> (), failure: @escaping (Error) -> ()){
        ...
        TwitterAPICaller.client?.fetchRequestToken(withPath: url, method: "GET", callbackURL: URL(string: "dbOAuth://oauth"), scope: nil, success: { (requestToken: BDBOAuth1Credential!) -> Void in
